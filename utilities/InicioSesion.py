    ...
    def startLogin(self,use = False):
        ...
        try:
            ...
            try:
                ...
                self.takescreenshot(driver, namescren="Exception", directory="ScreenshotsPruebaLogin/")
                self.createCVS(fieldnames=["Exception"], data=[{"Exception": "un error inesperado ocurrio"}],
                               name="Exception")
                driver.quit()
                return None
            if not use:
